...
export const PermissionModeSetup: React.FC<PermissionModeSetupProps> = ({ isOpen, onComplete }) => {
      ...
      <div className="bg-card border border-border rounded-xl w-full max-w-lg shadow-2xl">
        ...
        <div className="p-5 border-b border-border">
          ...
          <p className="text-sm text-muted-foreground">
            Claude Code 2.1.7+ supports preserving your permission mode after plan approval. Choose
            your preferred automation level.
          </p>
          <p className="text-xs text-muted-foreground/70 mt-1">
            Requires Claude Code 2.1.7 or later. Run{' '}
            <code className="bg-muted px-1 rounded">claude update</code> to update.
          </p>
        </div>
